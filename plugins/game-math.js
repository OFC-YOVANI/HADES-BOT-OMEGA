...
let mat =`
*[❗𝐈𝐍𝐅𝐎❗] Be a difficulty you want to play with*

*Difficulties available: ${Object.keys(modes).join(' | ')}*
...
let id = m.chat
if (id in global.math) return conn.reply(m.chat, '*[❗𝐈𝐍𝐅𝐎❗] There are still unanswered questions in the chat!*', global.math[id][0])
let math = genMath(mode)
global.math[id] = [
await conn.reply(m.chat, `How much is the result of *${math.str}*?\n\n*⏳ Time: ${(math.time / 1000).toFixed(2)} seconds*\n*🏆 Earn up to: ${math.bonus} 𝚇𝙿*`, m),
math, 4,
setTimeout(() => { 
if (global.math[id]) conn.reply(m.chat, `*[❗𝐈𝐍𝐅𝐎❗] The time is rendered to reappender*\n\n*The answer is ${math.result}*`, m),
