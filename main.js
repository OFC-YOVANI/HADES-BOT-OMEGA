...
const connectionOptions = {
  ...
  browser: ['HADES-BOT-MD', 'Safari', '1.0.0'],
  version,
...
global.reloadHandler = async function(restatConn) {
  ...
  conn.welcome = '乂✰@subject\n乂✰@user\n Welcome to the group please read the description to avoid having problems with the group creator\n\n@desc\n\n乂✰Enjoy your stay';
  conn.bye = '乂✰@user\n乂✰Left the group goodbye come back soon';
  conn.spromote = '乂✰@user\n乂✰Has joined the management team ';
  conn.sdemote = '乂✰@user\n乂 Admin team abandoned!!';
  conn.sDesc = '乂✰Group description has been changed\n@desc';
  conn.sSubject = '乂✰The group name has been changed\n@subject';
  conn.sIcon = '乂✰The group image has been modified';
  conn.sRevoke = '乂✰Group link updated\n@revoke';
...
setInterval(async () => {
  ...
  const bio = `🤖 This user makes use of HADES-BOT-MD active time ${uptime} `;
...
function clockString(ms) {
  ...
  return [d, 'días️', h, 'horas', m, 'minutos', s, 'segundos '].map((v) => v.toString().padStart(2, 0)).join('');
}
